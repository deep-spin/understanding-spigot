...
do      
    ...
    do
        ...
        do
            python sst_tt.py --learning_rate=$learning_rate --hidden_size=100 --hidden_size_out=100 --latent_grad_updates=1 --latent_step_size=$latent_step_size --latent_model_type=$latent_model_type
        done
    done
done