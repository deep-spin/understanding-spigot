...
if __name__ == '__main__':
    ...
    ax_vm.set_xlim(0.5, 10.5)
    ax_vm.set_xticks((1, 5, 10))
    ax_acc.set_xticks((1, 5, 10))
    ax_acc.set_xlabel("n. pull-back updates")
    ax_vm.set_xlabel("n. pull-back updates")
    ax_acc.set_ylabel("valid. accuracy")
    ax_vm.set_ylabel("valid. v-measure")
    ax_vm.legend()
    plt.savefig("impact_gr.pdf")
    # plt.show()
